...
for line in f:
	...
	if (num_list[5]%n == 0):
		os.system("touch labels/"+str(folder2)+"_"+str(folder1)+"_"+str(int(num_list[5]/n))+".txt")
		if (num_list[6] == 0) and (num_list[7]==0):
			# if temp2 != int(num_list[5]/n):
			# 	temp2 = int(num_list[5]/n)
			# 	with open('somefile.txt', 'a') as the_file:
			# 		the_file.write('\n')
			filename="labels/"+str(folder2)+"_"+str(folder1)+"_"+str(int(num_list[5]/n))+".txt"
